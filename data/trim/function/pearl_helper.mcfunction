...
tag @n[type=ender_pearl,distance=..1] add trim_assessed

# activate full set ability
execute if entity @s[tag=full_set_eye] unless items entity @s container.* ender_pearl[minecraft:custom_data~{trim_abilities_unender_pearl:1b}] run function trim:full_set/eye/1
