...
execute if data storage trim_abilities:reset_armor {item:{slot_type:'hotbar.'}} store result storage trim_abilities:reset_armor item.slot_index int 1 run data get storage trim_abilities:reset_armor item.container[{components:{"minecraft:attribute_modifiers":[{id:"trim:safe_fall_distance"}]}}].Slot
...
execute if data storage trim_abilities:reset_armor {item:{slot_type:'inventory.'}} store result score @s trim_flag run data get storage trim_abilities:reset_armor item.container[{components:{"minecraft:attribute_modifiers":[{id:"trim:safe_fall_distance"}]}}].Slot
