...
$execute if score @s trim.flag matches 0 run item modify entity @s $(slot_type)$(slot_index) {function:"minecraft:set_components",components:{"!minecraft:custom_data":{}}}
