...
execute if block ~ ~ ~ #trim:chest_or_barrel run function trim:full_set/coast/loot/3 with storage trim_abilities:loottables
execute if block ~ ~ ~ #trim:chest_or_barrel run return 0
