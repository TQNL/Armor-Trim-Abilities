...
execute store success score #degredation_level trim.flag run data modify storage trim_abilities:copper_bolting root.test_string set from storage trim_abilities:copper_bolting root.degredation_level

execute if score #degredation_level trim.flag matches 0 run data modify storage trim_abilities:copper_bolting root.base_id set string storage trim_abilities:copper_bolting root.modded_id 9
execute if score #degredation_level trim.flag matches 0 run return run function #trim:bolt_operations with storage trim_abilities:copper_bolting root
...
execute if score #degredation_level trim.flag matches 0 run data modify storage trim_abilities:copper_bolting root.base_id set string storage trim_abilities:copper_bolting root.modded_id 10
execute if score #degredation_level trim.flag matches 0 run return run function #trim:bolt_operations with storage trim_abilities:copper_bolting root
...
execute if score #degredation_level trim.flag matches 0 run data modify storage trim_abilities:copper_bolting root.base_id set string storage trim_abilities:copper_bolting root.modded_id 8
execute if score #degredation_level trim.flag matches 0 run return run function #trim:bolt_operations with storage trim_abilities:copper_bolting root
