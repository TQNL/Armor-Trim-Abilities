...
data remove entity @n[type=item_display,tag=trim_abilities_item_placeholder] item.components."minecraft:attribute_modifiers".modifiers[{id:"trim:attack_damage"}]
data remove entity @n[type=item_display,tag=trim_abilities_item_placeholder] item.components."minecraft:attribute_modifiers".modifiers[{id:"trim:attack_damage"}]
data remove entity @n[type=item_display,tag=trim_abilities_item_placeholder] item.components."minecraft:attribute_modifiers".modifiers[{id:"trim:attack_damage"}]
data remove entity @n[type=item_display,tag=trim_abilities_item_placeholder] item.components."minecraft:attribute_modifiers".modifiers[{id:"trim:attack_damage"}]
