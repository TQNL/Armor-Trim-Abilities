...
execute unless entity @s[tag=!single_flow,tag=!full_set_flow] if items entity @s inventory.* *[custom_data~{trim_abilities:1b}] at @s run function trim:single/flow/reset_flow_armor {slot_type:"inventory."}
execute unless entity @s[tag=!single_flow,tag=!full_set_flow] if items entity @s hotbar.* *[custom_data~{trim_abilities:1b}] at @s run function trim:single/flow/reset_flow_armor {slot_type:"hotbar."}
...
execute unless entity @s[tag=!single_bolt,tag=!full_set_bolt] if items entity @s inventory.* *[custom_data~{trim_abilities:1b}] at @s run function trim:single/bolt/reset_bolt_armor {slot_type:"inventory."}
execute unless entity @s[tag=!single_bolt,tag=!full_set_bolt] if items entity @s hotbar.* *[custom_data~{trim_abilities:1b}] at @s run function trim:single/bolt/reset_bolt_armor {slot_type:"hotbar."}
execute unless entity @s[tag=!single_bolt,tag=!full_set_bolt] if items entity @s weapon.offhand *[custom_data~{trim_abilities:1b}] at @s run function trim:single/bolt/reset_bolt_armor {slot_type:"weapon."}
